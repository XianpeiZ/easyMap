<template>
  <div class="home">
    ...
    <div class="dash">
      <div>
        <el-row>
          <el-col :span="5" class="dashtitle"><h2>test</h2>
            <div class="grid-content bg-purple"></div>
          </el-col>
          <el-col :span="9" :push="10" style="padding-left: 2%;">
            <div class="grid-content bg-purple">
              <el-button :plain="true" type="info" @click.native="addDashButton"><i
                class="el-icon-plus el-icon--left"></i> 新建MAP
              </el-button>
              <el-button :plain="true" type="info" @click.native="formatLayout"><i
                class="el-icon-menu el-icon--left"></i>保存
              </el-button>
          ...
          <span class="editdialog">
                <el-dialog title="card" :visible.sync="editDialogFormVisible ">
                  ...
                  <el-form :model="editForm">
                    <el-form-item label="添加备注" :label-width="formLabelWidth" size="medium">
