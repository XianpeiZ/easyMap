...
<div class="home">
  <!-- <el-row class="dashcontent">
    ...
    <div  class="dash">
        	<div>
        		<el-row>
				  <el-col :span="5" class="dashtitle"><h2>{{map.name}}</h2><div class="grid-content bg-purple"></div></el-col>
				  <el-col :span="15" :push="10" style="padding-left: 2%;">
				  	<div class="grid-content bg-purple">
							<el-button  :plain="true"  type="info" @click.native ="showMapDialogVisible = true"><i class="el-icon-view el-icon--left" ></i> Show Map</el-button>
				  		<el-button  :plain="true"  type="info" @click.native ="newMapDialogVisible = true"><i class="el-icon-plus el-icon--left" ></i> New Map</el-button>
						<el-button  :plain="true"  type="info" @click.native ="deleteMap"><i class="el-icon-delete el-icon--left"></i>Delete Map</el-button>
						<el-button  :plain="true"  type="info" @click.native ="saveMap"><i class="el-icon-document el-icon--left"></i>Save</el-button>
				  	</div>
				  </el-col>
				</el-row>
        	</div>
    ...
    <grid-layout
			        ...
			        <grid-item v-for="(item,index) in layout1"
							 ...
							 <el-row class="editButton">
								<!--<el-col :span="21">-->
								<el-button type="text" @click.native="editDialogFormVisible = true">编辑</el-button>
								<!--</el-col>-->
            				</el-row>
			        </grid-item>
                ...
                <el-dialog title="card" :visible.sync="editDialogFormVisible ">
                  ...
                  <div slot="footer" class="dialog-footer">
                    ...
                    <el-button type="primary" @click.native="addComments">确 定</el-button>
                  </div>
                </el-dialog>
              </span>
							<grid-item
